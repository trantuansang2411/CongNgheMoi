...
const searchCourses = async (req, res, next) => {
    try {
        ...
        res.json({ success: true, data: await svc.searchCourses({ keyword, topicId, minPrice, maxPrice, minRating, minDurationSec, maxDurationSec, sortBy, page: +page || 1, limit: +limit || 20 }) });
    } catch (e) { next(e); }
};
